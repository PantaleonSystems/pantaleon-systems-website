...
- **Vite** + **React 19** + **TypeScript** (strict). (Nota: o scaffold instalou React 19.2.7,
  não 18 como originalmente escrito aqui — decisão consciente, mantido por ser o que o
  `create-vite` mais recente entrega e por ser retrocompatível com os padrões usados no
  protótipo.)
